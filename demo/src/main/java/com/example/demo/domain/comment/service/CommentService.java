...
@Transactional(readOnly = true)            // 기본적으로 이 클래스의 메서드는 "읽기 전용 트랜잭션"으로 동작
...
public class CommentService {
    ...
    public Comment updateComment(Long commentId, String newContent) {
        ...
        // 2) 엔티티의 updateContent 메서드 호출
        comment.updateContent(newContent);

        // 3) @Transactional 상태라 save 필요 없음, 변경 감지로 자동 반영
        return comment;
    }
